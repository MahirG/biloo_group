...
export const marketingComparisons: MarketingComparison[] = [
  {
    slug: "excel",
    number: "01",
    eyebrow: "Biloo ERP vs spreadsheets",
    title: "Biloo ERP vs Excel for daily business management",
    shortTitle: "Biloo ERP vs Excel",
  ...
  },
  {
    slug: "notebooks",
    number: "02",
    eyebrow: "Biloo ERP vs paper records",
    title: "Biloo ERP vs notebooks and handwritten ledgers",
    shortTitle: "Biloo ERP vs notebooks",
  ...
  },
  {
    slug: "separate-tools",
    number: "03",
    eyebrow: "Biloo ERP vs disconnected apps",
    title: "Biloo ERP vs separate accounting, inventory and sales tools",
    shortTitle: "Biloo ERP vs separate tools",
  ...
  },
  {
    ...
    title: "Biloo ERP cloud workspace vs traditional desktop software",
    ...
    hisabLabel: "Biloo ERP cloud workspace",
    ...
    rows: [
      ...
      { capability: "Infrastructure", alternative: "Local server, workstation and backup responsibilities", hisab: "Hosted application with shared platform responsibilities", why: "The customer still manages users and data quality while Biloo ERP manages application delivery." },
      ...
      { capability: "Security model", alternative: "Depends heavily on local network and device administration", hisab: "Application controls plus hosting-platform controls", why: "Security responsibilities are divided between Biloo ERP, providers and the customer." },
    ],
  ...
  },
  {
    ...
    title: "Biloo ERP for growing businesses vs large enterprise ERP suites",
