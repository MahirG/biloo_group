...
export const helpArticles: HelpArticle[] = [
  {
    ...
    prerequisites: ["A verified Biloo ERP account", "The legal or operating business name", "A designated organization owner"],
    steps: [
  ...
  },
  {
    ...
    notes: ["Biloo ERP requires stronger authentication for protected administrative mutations.", "MFA cannot protect a session if the user approves a fraudulent prompt or exposes recovery material."],
  ...
  },
  {
    ...
    summary: "Match external payment activity with Biloo ERP records and keep unresolved exceptions visible for review.",
    readTime: "9 min",
  ...
  },
  {
    ...
    prerequisites: ["Export access to the current source", "An assigned data owner", "A cutover plan", "The Biloo ERP import templates"],
    steps: [
      ...
      { title: "Map fields to the template", text: "Use the Biloo ERP column names and keep one row per unique customer, supplier or product." },
  ...
  },
  {
    ...
    summary: "Reconcile the final source position, approve opening balances and control the transition into live Biloo ERP operations.",
    readTime: "9 min",
  ...
  },
  {
    ...
    summary: "Review what Biloo ERP records, which controls require configuration and which responsibilities remain with the customer.",
    readTime: "8 min",
    ...
    notes: ["Biloo ERP does not claim certifications or recovery capabilities that have not been independently verified.", "Customers remain responsible for user access, device security, data quality and lawful use."],
