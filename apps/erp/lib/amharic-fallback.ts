const phraseEntries: Array<[string, string]> = [
  ...
  ["Why businesses choose Biloo ERP", "ንግዶች Biloo ERPን ለምን ይመርጣሉ"],
...
const protectedTokens = new Set(["Biloo ERP", "Biloo ERP", "ERP", "ETB", "CSV", "API", "MFA", "OAuth", "Supabase", "telebirr", "M-PESA", "Google", "Apple", "WhatsApp", "Excel"]);
