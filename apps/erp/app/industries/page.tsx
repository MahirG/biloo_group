...
export const metadata: Metadata = {
  ...
  description: "Explore Biloo ERP solutions for retail, wholesale, hospitality, services, construction, manufacturing, cooperatives, trade and multi-branch Ethiopian businesses.",
};
  ...
  return (
    <MarketingPageShell>
      <section className="industry-index-hero">
        <div><span className="marketing-eyebrow">Industry solutions</span><h1>See Biloo ERP through the workflow of your business.</h1><p>Every industry uses sales, expenses, inventory, customers, suppliers and finance differently. These solution pages show how connected ERP records support the decisions each team makes.</p><div className="marketing-hero-actions"><Link href="/request-demo" className="marketing-start marketing-large">Request an industry demo</Link><Link href="/product-tour" className="marketing-demo marketing-large">Explore the product</Link></div></div>
