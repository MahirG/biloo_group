...
export const metadata: Metadata = {
  title: "Biloo ERP Pricing in Ethiopian Birr",
  description: "Compare Biloo ERP plans in ETB and pay securely through Chapa for a monthly or annual access period.",
};
...
const questions = [
  ...
  { q: "How is payment confirmed?", a: "Chapa hosts the payment page. Biloo ERP then verifies the transaction reference, ETB amount, currency and successful status directly with Chapa before activating access." },
  { q: "Does payment renew automatically?", a: "No. Biloo ERP uses one-time Chapa payments. Renewal is manual, so a customer is never enrolled in an automatic recurring charge through this flow." },
...
export default function PricingPage() {
  return (
    <MarketingPageShell>
      ...
      <section className="marketing-cta marketing-cta-v2"><div><span>Need help choosing a plan?</span><h2>Use Chapa checkout or discuss complex scope.</h2><p>Standard plans can begin online. Biloo ERP will guide migration, integrations, Enterprise requirements and specialized implementation.</p></div><div><Link href="/request-demo?topic=pricing" className="marketing-start marketing-large">Request pricing consultation</Link><Link href="/product-tour" className="marketing-demo marketing-large">Explore the product</Link></div></section>
    </MarketingPageShell>
  );
}
