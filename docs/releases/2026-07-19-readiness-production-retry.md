# Readiness production retry

This release marker triggers a clean Vercel production deployment from `main` after the Hobby build-rate cooldown.

Included release scope:

- standardized Hisab design system
- professional Amharic and Tigrinya translation review workflow
