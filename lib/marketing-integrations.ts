...
export const integrationStatusCopy: Record<IntegrationStatus, { label: string; description: string }> = {
  available: { label: "Available", description: "Implemented in the current Biloo ERP application." },
...
export const marketingIntegrations: MarketingIntegration[] = [
  {
    ...
    summary: "Biloo ERP uses Supabase for authenticated application access and its PostgreSQL data foundation.",
  ...
  },
  {
    ...
    status: "available",
    statusLabel: "Available",
    summary: "Users can access Biloo ERP with email and password or request a password-free magic sign-in link.",
  ...
  },
  {
    ...
    status: "beta",
    statusLabel: "Beta",
    summary: "Biloo ERP can receive token-protected telebirr callback events and normalize them into the reconciliation workflow.",
  ...
  },
  {
    ...
    status: "beta",
    statusLabel: "Beta",
    summary: "Biloo ERP can receive M-PESA Daraja callback events and normalize receipt, amount, phone and order references for reconciliation.",
