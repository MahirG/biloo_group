    ...
    <main className="route-loading brand-route-loading" role="status" aria-live="polite" aria-label="Loading secure workspace">
      <div className="experience-loader-card brand-loader-card">
        <div className="brand-loader-mark" aria-hidden="true">
          ...
          <span className="brand-loader-logo-shell"><img src="/biloo-erp-mark.svg" alt="" width="48" height="48" /></span>
        </div>
    ...
    ? (
      <main className="mfa-required-page">
        <section className="mfa-required-card">
          ...
          <p>Biloo ERP now requires authenticator MFA before an owner or administrator can change financial, inventory, payroll, user or security data.</p>
  ...
  return (
    <div className="erp-shell" data-layout-version="supabase-sidebar-v2" data-mobile-nav-open={mobileNavOpen ? "true" : "false"}>
      ...
      <header className="mobile-workspace-header">
        ...
        <Link href="/" className="mobile-workspace-brand" aria-label="Biloo ERP dashboard"><img src="/biloo-erp-mark.svg" alt="" width="34" height="34" className="hisab-logo" /></Link>
      ...
      <aside className="sidebar supabase-sidebar" id="primary-sidebar" data-docked="hover" aria-label="Primary workspace navigation">
        <div className="mobile-sidebar-header">
          <div className="brand"><img src="/biloo-erp-mark.svg" alt="" width="34" height="34" className="hisab-logo" /><div><strong>Hisab</strong><small>{d.brandSubtitle}</small></div></div>
        ...
        <div className="supabase-sidebar-header">
          <Link href="/" className="desktop-sidebar-brand brand" aria-label="Biloo ERP dashboard">
            <img src="/biloo-erp-mark.svg" alt="" width="28" height="28" className="hisab-logo" />
            <div><strong>Biloo ERP</strong><small>{d.brandSubtitle}</small></div>
          </Link>
        ...
        <footer className="sidebar-footer"><p className="powered-by">Powered by <a href="https://www.biloogroup.com" target="_blank" rel="noopener noreferrer">Biloo ERP</a></p><p>{user.organizationName}<br />Addis Ababa, Ethiopia</p></footer>
      </aside>
